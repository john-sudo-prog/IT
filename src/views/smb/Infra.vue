  ...
  <div>
    ...
    <header class="sticky top-0 z-30 bg-white/80 backdrop-blur border-b border-gray-100">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <nav class="hidden md:flex items-center gap-8 text-sm">
          ...
          <a href="/#services" class="hover:text-blue-600">云服务产品</a>
          <a href="/#solutions" class="hover:text-blue-600">SMB服务级别</a>
          <a href="/#cases" class="hover:text-blue-600">成功案例</a>
    ...
    <section class="py-16">
      <div class="max-w-5xl mx-auto px-6">
        <h2 class="section-title">基础设施管理详述</h2>
        <h3 class="text-xl font-semibold mt-8 mb-3">监控和维护</h3>
        <ul class="list-disc pl-6 space-y-2 text-gray-700">
          <li>实时监控：24/7 观测核心指标（CPU/内存/网络），快速定位异常。</li>
          <li>预警机制：阈值触发与告警联动，问题未发生先感知、先处置。</li>
        </ul>

        <h3 class="text-xl font-semibold mt-8 mb-3">资源管理</h3>
        <ul class="list-disc pl-6 space-y-2 text-gray-700">
          <li>资源优化：依据使用画像动态调优实例、存储与带宽，避免浪费。</li>
          <li>成本控制：提供细粒度用量报告与建议，确保预算可控。</li>
        </ul>

        <h3 class="text-xl font-semibold mt-8 mb-3">灾难恢复</h3>
        <ul class="list-disc pl-6 space-y-2 text-gray-700">
          <li>DR 方案：按业务RPO/RTO制定备份与恢复流程，满足合规与连续性。</li>
          <li>演练与测试：定期演练验证可恢复性，确保突发情况快速复原。</li>
        </ul>
      </div>
    </section>
...
<style scoped>
.section-title { @apply text-3xl md:text-4xl font-bold text-gray-900 mb-6; }
</style>
